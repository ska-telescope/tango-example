...
def _get_wrapped_read_method(attribute, read_method):
    ...
    already_wrapped = hasattr(read_method, "__wrapped_access__")
    if already_wrapped:
        return read_method
    ...
    read_attr.__wrapped_access__ = True
    return read_attr
...
def _get_wrapped_write_method(attribute, write_method):
    ...
    """
    already_wrapped = hasattr(write_method, "__wrapped_access__")
    if already_wrapped:
        return write_method
    ...
    write_attr.__wrapped_access__ = True
    return write_attr
...
def _get_wrapped_isallowed_method(attribute, isallowed_method):
    ...
    """
    already_wrapped = hasattr(isallowed_method, "__wrapped_access__")
    if already_wrapped:
    ...
    if isallowed_attr is not isallowed_method:
        isallowed_attr.__wrapped_access__ = True
...
def _get_wrapped_pipe_read_method(pipe, read_method):
    ...
    if read_pipe is not read_method:
        read_pipe.__wrapped_access__ = True
    return read_pipe
...
def _get_wrapped_pipe_write_method(pipe, write_method):
    ...
    write_pipe.__wrapped_access__ = True
    return write_pipe
...
def __patch_is_command_allowed_method(tango_device_klass, is_allowed_method, cmd_name):
    ...
    :type cmd_name: str
    """
    already_wrapped = hasattr(is_allowed_method, "__wrapped_access__")
    if already_wrapped:
    ...
    wrapped_method.__wrapped_access__ = True
...
def __patch_standard_device_methods(klass):
    ...
    already_wrapped = hasattr(init_device_orig, "__wrapped_access__")
    if not already_wrapped:
        ...
        init_device.__wrapped_access__ = True
        setattr(klass, "init_device", init_device)

    delete_device_orig = klass.delete_device
    already_wrapped = hasattr(delete_device_orig, "__wrapped_access__")
    if not already_wrapped:
        ...
        delete_device.__wrapped_access__ = True
        setattr(klass, "delete_device", delete_device)

    dev_state_orig = klass.dev_state
    already_wrapped = hasattr(dev_state_orig, "__wrapped_access__")
    if not already_wrapped:
        ...
        dev_state.__wrapped_access__ = True
        setattr(klass, "dev_state", dev_state)

    dev_status_orig = klass.dev_status
    already_wrapped = hasattr(dev_status_orig, "__wrapped_access__")
    if not already_wrapped:
        ...
        dev_status.__wrapped_access__ = True
        setattr(klass, "dev_status", dev_status)

    read_attr_hardware_orig = klass.read_attr_hardware
    already_wrapped = hasattr(read_attr_hardware_orig, "__wrapped_access__")
    if not already_wrapped:
        ...
        read_attr_hardware.__wrapped_access__ = True
        setattr(klass, "read_attr_hardware", read_attr_hardware)

    always_executed_hook_orig = klass.always_executed_hook
    already_wrapped = hasattr(always_executed_hook_orig, "__wrapped_access__")
    if not already_wrapped:
        ...
        always_executed_hook.__wrapped_access__ = True
